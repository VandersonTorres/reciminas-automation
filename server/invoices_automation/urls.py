...
urlpatterns = [
    ...
    path("controle-nfs/", access_entry_invoices_queue, name="access_entry_invoices_queue"),
    path("fila/excluir/<int:pk>/", delete_entry_invoice, name="delete_entry_invoice"),
    path("fila/editar/<int:pk>/", edit_entry_invoice, name="edit_entry_invoice"),
    ...
    path("emitir-nota/<int:invoice_pk>/", emit_entry_invoice, name="emit_entry_invoice"),
